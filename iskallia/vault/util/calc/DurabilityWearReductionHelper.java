...
public class DurabilityWearReductionHelper {
   public static float getDurabilityWearReduction(LivingEntity entity) {
      return Mth.clamp(getDurabilityWearReductionUnlimited(entity), 0.0F, AttributeLimitHelper.getDurabilityWearReductionLimit(entity));
   }

   public static float getDurabilityWearReductionUnlimited(LivingEntity entity) {
      float result = 0.0F;
