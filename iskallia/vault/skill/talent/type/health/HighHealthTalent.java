...
public abstract class HighHealthTalent extends ConditionalEntitySkill {
   private float healthThreshold;

   public HighHealthTalent(int unlockLevel, int learnPointCost, int regretPointCost, MobEffect effect, float healthThreshold) {
      super(unlockLevel, learnPointCost, regretPointCost, effect);
      this.healthThreshold = healthThreshold;
   }

   protected HighHealthTalent() {
   }
