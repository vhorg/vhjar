...
public class ImplodeAbility extends InstantManaAbility {
   private float radius;
   private float percentManaDealt;

   public ImplodeAbility(int unlockLevel, int learnPointCost, int regretPointCost, int cooldownTicks, float manaCost, float radius, float percentManaDealt) {
            ...
            player -> {
               ...
               if (manaPlayer != null) {
                  ...
                  if (!player.isCreative()) {
                     manaPlayer.decreaseMana(ManaAction.PLAYER_ACTION, mana);
                  }
               }
