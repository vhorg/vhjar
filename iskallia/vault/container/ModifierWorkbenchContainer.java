...
public class ModifierWorkbenchContainer extends AbstractElementContainer {
   private final ModifierWorkbenchTileEntity tileEntity;
   private final BlockPos tilePos;

   public ModifierWorkbenchContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory) {
      super(ModContainers.MODIFIER_WORKBENCH_CONTAINER, windowId, playerInventory.player);
      this.tilePos = pos;
      if (world.getBlockEntity(this.tilePos) instanceof ModifierWorkbenchTileEntity workbench) {
   ...
   public ModifierWorkbenchTileEntity getTileEntity() {
