...
public class VaultRecyclerContainer extends AbstractElementContainer {
   private final VaultRecyclerTileEntity tileEntity;
   private final BlockPos tilePos;

   public VaultRecyclerContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory) {
      super(ModContainers.VAULT_RECYCLER_CONTAINER, windowId, playerInventory.player);
      this.tilePos = pos;
      if (world.getBlockEntity(this.tilePos) instanceof VaultRecyclerTileEntity recyclerTileEntity) {
   ...
   private void initSlots(Inventory playerInventory) {
      ...
      this.addSlot(new Slot(ct, 0, 36, 22) {
         public boolean mayPlace(ItemStack stack) {
            return VaultRecyclerContainer.this.tileEntity.isValidInput(stack);
         }
      });
      this.addSlot(new RecipeOutputSlot(ct, 1, 88, 22));
      this.addSlot(new RecipeOutputSlot(ct, 2, 106, 22));
      this.addSlot(new RecipeOutputSlot(ct, 3, 124, 22));
   }
   ...
   public VaultRecyclerTileEntity getTileEntity() {
