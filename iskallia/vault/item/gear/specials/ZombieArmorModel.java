...
public class ZombieArmorModel<T extends LivingEntity> extends VaultGearModel<T> {
   public ZombieArmorModel(float modelSize, EquipmentSlotType slotType) {
      ...
      this.field_78089_u = this.isLayer2() ? 32 : 32;
      ...
      cube_r1.func_78793_a(0.0F, 1.5F, 5.0F);
      this.Body.func_78792_a(cube_r1);
      this.setRotationAngle(cube_r1, -0.9163F, 0.0F, 0.0F);
      cube_r1.func_78784_a(41, 1).func_228303_a_(-1.0F, 1.25F, -2.0F, 2.0F, 1.0F, 4.0F, 0.0F, false);
      ...
      this.RightBoot.func_78784_a(0, 16).func_228303_a_(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 1.0F, false);
      this.LeftBoot = new ModelRenderer(this);
      this.LeftBoot.func_78793_a(1.9F, 12.0F, 0.0F);
      this.LeftBoot.func_78784_a(0, 16).func_228303_a_(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 1.0F, true);
