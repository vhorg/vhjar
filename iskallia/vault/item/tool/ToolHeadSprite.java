...
public class ToolHeadSprite extends TextureAtlasSprite {
   public ToolHeadSprite(TextureAtlas atlas, Info info, int mipLevel, int storageX, int storageZ, int x, int y, NativeImage image) {
      super(atlas, info, mipLevel, storageX, storageZ, x, y, image);
   }

   public static ToolHeadSprite create(
