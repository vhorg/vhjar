...
public class OfferingBossCrystalObjective extends CrystalObjective {
   protected float objectiveProbability;

   public OfferingBossCrystalObjective() {
   }

   public OfferingBossCrystalObjective(float objectiveProbability) {
   ...
   public void configure(Vault vault, RandomSource random) {
      ...
      vault.ifPresent(
         ...
         objectives -> {
            objectives.add(
               OfferingBossObjective.of(this.objectiveProbability)
                  .add(AwardCrateObjective.ofConfig(VaultCrateBlock.Type.OFFERING_BOSS, "offering_boss", level, true))
   ...
   public void addText(List<Component> tooltip, int minIndex, TooltipFlag flag, float time) {
      tooltip.add(
         new TextComponent("Objective: ").append(new TextComponent("Offering Boss").withStyle(Style.EMPTY.withColor(this.getColor(time).orElseThrow())))
      );
   }
