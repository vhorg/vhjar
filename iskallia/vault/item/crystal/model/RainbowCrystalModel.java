...
public class RainbowCrystalModel extends CoreCrystalModel {
   @Override
   public ModelResourceLocation getItemModel() {
      return new ModelResourceLocation("the_vault:crystal/core/rainbow#inventory");
   }
   ...
   public int getBlockColor(CrystalData crystal, float time) {
      return Color.getHSBColor(time / 200.0F, 1.0F, 1.0F).getRGB();
   }
