...
public class JewelCraftingTableRenderer implements BlockEntityRenderer<JewelCraftingTableTileEntity> {
   public JewelCraftingTableRenderer(Context context) {
   }

   public void render(
      JewelCraftingTableTileEntity tile,
      float partialTicks,
      ...
      ItemStack jewel = tile.getResultContainer().getItem(0);
      if (!jewel.isEmpty()) {
         poseStack.pushPose();
