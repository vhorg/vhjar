...
public class RaidControllerProxyRenderer implements BlockEntityRenderer<RaidControllerProxyBlockEntity> {
   private final Font font;

   public RaidControllerProxyRenderer(Context context) {
      this.font = context.getFont();
   }

   public void render(
      RaidControllerProxyBlockEntity entity, float partialTick, PoseStack matrixStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay
   ) {
