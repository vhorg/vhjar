...
public class AngelBlockRenderer implements BlockEntityRenderer<AngelBlockTileEntity> {
   public static final Material ANGEL_OUTTER = new Material(TextureAtlas.LOCATION_BLOCKS, VaultMod.id("entity/angel/angel_outter"));
   public static final Material ANGEL_OUTTER2 = new Material(TextureAtlas.LOCATION_BLOCKS, VaultMod.id("entity/angel/angel_outter2"));
   public static final Material ANGEL_WIND = new Material(TextureAtlas.LOCATION_BLOCKS, VaultMod.id("entity/angel/angel_wind"));
   public static final Material ANGEL_WIND_VERTICAL = new Material(TextureAtlas.LOCATION_BLOCKS, VaultMod.id("entity/angel/angel_wind_vertical"));
   public static final Material ANGEL_CENTER = new Material(TextureAtlas.LOCATION_BLOCKS, VaultMod.id("entity/angel/angel_center"));
   private final ModelPart eye;
   private final ModelPart wind;
   private final ModelPart cage;
   private final BlockEntityRenderDispatcher renderer;

   public AngelBlockRenderer(Context pContext) {
   ...
   public void render(
      AngelBlockTileEntity pBlockEntity,
      float partialTicks,
      ...
      if (world != null) {
         ...
         this.cage.render(pPoseStack, ANGEL_OUTTER.buffer(pBufferSource, RenderType::entityCutoutNoCull), pPackedLight, pPackedOverlay);
         pPoseStack.popPose();
         pPoseStack.pushPose();
         float scale = 1.5F;
         ...
         pPoseStack.mulPose(vector3f.rotationDegrees(-f1));
         this.cage.render(pPoseStack, ANGEL_OUTTER2.buffer(pBufferSource, RenderType::entityCutoutNoCull), pPackedLight, pPackedOverlay);
         pPoseStack.popPose();
         pPoseStack.popPose();
         pPoseStack.popPose();
         int i = 1;
         ...
         VertexConsumer vertexconsumer = ANGEL_WIND_VERTICAL.buffer(pBufferSource, RenderType::entityCutoutNoCull);
         this.wind.render(pPoseStack, vertexconsumer, pPackedLight, pPackedOverlay);
         pPoseStack.popPose();
         pPoseStack.pushPose();
         pPoseStack.translate(0.5, 0.5, 0.5);
         pPoseStack.scale(0.875F, 0.875F, 0.875F);
         vertexconsumer = ANGEL_WIND.buffer(pBufferSource, RenderType::entityCutoutNoCull);
         pPoseStack.mulPose(vector3f.rotationDegrees(-f1));
         this.wind.render(pPoseStack, vertexconsumer, pPackedLight, pPackedOverlay);
         pPoseStack.popPose();
         ...
         this.eye.render(pPoseStack, ANGEL_CENTER.buffer(pBufferSource, RenderType::entityCutoutNoCull), pPackedLight, pPackedOverlay);
         pPoseStack.popPose();
      }
   }
}
