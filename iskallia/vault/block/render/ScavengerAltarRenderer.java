...
public class ScavengerAltarRenderer implements BlockEntityRenderer<ScavengerAltarTileEntity> {
   public ScavengerAltarRenderer(Context context) {
   }

   public void render(
      ScavengerAltarTileEntity scavengerAltarTileEntity,
      float partialTicks,
