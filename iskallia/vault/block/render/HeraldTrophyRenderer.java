...
public class HeraldTrophyRenderer implements BlockEntityRenderer<HeraldTrophyTileEntity> {
   public HeraldTrophyRenderer(Context context) {
   }

   public void render(
      @Nonnull HeraldTrophyTileEntity tileEntity,
      float partialTicks,
      ...
      if (world != null) {
         ...
         Direction facing = (Direction)blockState.getValue(HeraldTrophyBlock.FACING);
