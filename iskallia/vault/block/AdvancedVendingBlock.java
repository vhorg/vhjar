...
public class AdvancedVendingBlock extends Block {
   ...
   public TileEntity createTileEntity(BlockState state, IBlockReader world) {
      return state.func_177229_b(HALF) == DoubleBlockHalf.LOWER ? ModBlocks.ADVANCED_VENDING_MACHINE_TILE_ENTITY.func_200968_a() : null;
   }
   ...
   public ActionResultType func_225533_a_(BlockState state, final World world, final BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
      ...
      if (machine == null) {
         ...
         NetworkHooks.openGui((ServerPlayerEntity)player, new INamedContainerProvider() {
            ...
            BlockState blockState = world.func_180495_p(pos);
            buffer.func_179255_a(getVendingMachinePos(blockState, pos));
         });
         return ActionResultType.SUCCESS;
      }
   }
   ...
   public static AdvancedVendingTileEntity getAdvancedVendingMachineTile(World world, BlockPos pos, BlockState state) {
      ...
      TileEntity tileEntity = world.func_175625_s(vendingMachinePos);
      return !(tileEntity instanceof AdvancedVendingTileEntity) ? null : (AdvancedVendingTileEntity)tileEntity;
   }
}
