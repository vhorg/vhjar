...
public class VendingMachineScreen extends ContainerScreen<VendingMachineContainer> {
   ...
   public List<TradeWidget> tradeWidgets = new LinkedList<>();
   ...
   public void refreshWidgets() {
      ...
      List<TraderCore> cores = ((VendingMachineContainer)this.func_212873_a_()).getTileEntity().getCores();
      ...
      for (int i = 0; i < this.tradeWidgets.size(); i++) {
         ...
         if (isHovered) {
            if (InputEvents.isShiftDown()) {
               ((VendingMachineContainer)this.func_212873_a_()).ejectCore(i);
               this.refreshWidgets();
               ...
               ((VendingMachineContainer)this.func_212873_a_()).selectTrade(i);
   ...
   public void func_230430_a_(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      VendingMachineContainer container = (VendingMachineContainer)this.func_212873_a_();
