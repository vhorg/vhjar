...
public class GlobalTraderScreen extends ContainerScreen<GlobalTraderContainer> {
   ...
   public ScrollableContainer tradesContainer = new ScrollableContainer(this::renderTrades);
   public List<GlobalTradeWidget> tradeWidgets = new LinkedList<>();
   ...
   public void refreshWidgets() {
      ...
      List<Trade> trades = ((GlobalTraderContainer)this.func_212873_a_()).getPlayerTrades();

      for (int i = 0; i < trades.size(); i++) {
         Trade trade = trades.get(i);
         int x = 0;
         int y = i * 27;
         this.tradeWidgets.add(new GlobalTradeWidget(x, y, trade, this));
      }
   }
   ...
   public void func_212927_b(double mouseX, double mouseY) {
      ...
      for (GlobalTradeWidget tradeWidget : this.tradeWidgets) {
   ...
   public boolean func_231044_a_(double mouseX, double mouseY, int button) {
      ...
      for (int i = 0; i < this.tradeWidgets.size(); i++) {
         GlobalTradeWidget tradeWidget = this.tradeWidgets.get(i);
         ...
         if (isHovered) {
            ((GlobalTraderContainer)this.func_212873_a_()).selectTrade(i);
   ...
   public void func_230430_a_(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      GlobalTraderContainer container = (GlobalTraderContainer)this.func_212873_a_();
