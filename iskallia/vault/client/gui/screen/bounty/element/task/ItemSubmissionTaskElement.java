...
public class ItemSubmissionTaskElement extends AbstractTaskElement<ItemSubmissionTask> {
   protected ItemSubmissionTaskElement(ISpatial spatial, ItemSubmissionTask task) {
      super(spatial, task);
   }
