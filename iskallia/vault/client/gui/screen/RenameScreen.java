...
public class RenameScreen extends ContainerScreen<RenamingContainer> {
   ...
   public RenameScreen(RenamingContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
      ...
      this.field_147000_g = 61;
      this.field_238742_p_ = 59;
      ...
      } else if (this.renameType == RenameType.TRADER_CORE) {
         this.traderCircuit = ItemStack.func_199557_a(this.data);
         CompoundNBT stackNbt = this.traderCircuit.func_196082_o();
      ...
      } else if (this.renameType == RenameType.CRYO_CHAMBER) {
   ...
   protected void initFields() {
      ...
      this.nameField = new TextFieldWidget(this.field_230712_o_, i + 7, j + 26, 103, 12, new StringTextComponent(this.name));
   ...
   private void confirmPressed(Button button) {
      ...
      if (this.renameType == RenameType.PLAYER_STATUE) {
         ...
         try {
            ...
            this.traderCircuit.func_77982_d(stackNbt);
            nbt.func_218657_a("Data", this.traderCircuit.serializeNBT());
   ...
   private void renderTitle(MatrixStack matrixStack) {
      int i = (this.field_230708_k_ - this.field_146999_f) / 2;
      int j = (this.field_230709_l_ - this.field_147000_g) / 2;
      float startX = i + this.field_238742_p_ - this.field_230712_o_.func_78256_a("Rename Player") / 2;
