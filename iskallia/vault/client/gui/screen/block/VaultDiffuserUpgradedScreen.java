...
public class VaultDiffuserUpgradedScreen extends AbstractElementContainerScreen<VaultDiffuserUpgradedContainer> {
   private final Inventory playerInventory;

   public VaultDiffuserUpgradedScreen(VaultDiffuserUpgradedContainer container, Inventory inventory, Component title) {
      ...
      this.addElement(
         (LabelElement)new LabelElement(
               ...
               ((VaultDiffuserUpgradedContainer)this.getMenu()).getTileEntity().getDisplayName().copy().withStyle(Style.EMPTY.withColor(-12632257)),
      ...
      this.addElement(
         (ProgressElement)new ProgressElement(
               Spatials.positionXY(124, 50),
               ScreenTextures.PROGRESS_ARROW,
               ((VaultDiffuserUpgradedContainer)this.getMenu()).getTileEntity()::getProgressPercent
            )
            .layout((screen, gui, parent, world) -> world.translateXY(gui))
      );
   }
