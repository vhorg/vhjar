...
public class VaultRecyclerScreen extends AbstractElementContainerScreen<VaultRecyclerContainer> {
   private final Inventory playerInventory;

   public VaultRecyclerScreen(VaultRecyclerContainer container, Inventory inventory, Component title) {
      ...
      this.addElement(
         (LabelElement)new LabelElement(
               ...
               ((VaultRecyclerContainer)this.getMenu()).getTileEntity().getDisplayName().copy().withStyle(Style.EMPTY.withColor(-12632257)),
      ...
      this.addElement(
         (ProgressElement)new ProgressElement(
               Spatials.positionXY(60, 22), ScreenTextures.PROGRESS_ARROW, ((VaultRecyclerContainer)this.getMenu()).getTileEntity()::getProgressPercent
            )
            .layout((screen, gui, parent, world) -> world.translateXY(gui))
      );
   }
