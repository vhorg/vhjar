...
public class TalentsElementContainerScreen extends LegacySkillTreeElementContainerScreen<TalentTree> {
   ...
   public TalentTree getTalentTree() {
      return (TalentTree)((NBTElementContainer)this.menu).getData();
   }
   ...
   public TabContent getTabContent() {
      TalentDialog talentDialog = new TalentDialog(this.getTalentTree(), this);
