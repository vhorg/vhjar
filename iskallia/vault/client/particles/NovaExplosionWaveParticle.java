...
public class NovaExplosionWaveParticle extends TextureSheetParticle {
   ...
   protected NovaExplosionWaveParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         return new NovaExplosionWaveParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, this.sprites);
      }
   }
}
