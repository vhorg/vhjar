...
public class WendarrSparkExplosionParticle extends TextureSheetParticle {
   ...
   protected WendarrSparkExplosionParticle(
   ...
   public void tick() {
      this.x = this.x + (this.random.nextFloat() * 0.15F - 0.075F);
      this.y = this.y + (this.random.nextFloat() * 0.15F - 0.075F);
      this.z = this.z + (this.random.nextFloat() * 0.15F - 0.075F);
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         return new WendarrSparkExplosionParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, this.sprites);
      }
   }
}
