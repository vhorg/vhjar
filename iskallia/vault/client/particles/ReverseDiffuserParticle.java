...
@OnlyIn(Dist.CLIENT)
public class ReverseDiffuserParticle extends TextureSheetParticle {
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         ReverseDiffuserParticle diffuserParticle = new ReverseDiffuserParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, this.sprite);
