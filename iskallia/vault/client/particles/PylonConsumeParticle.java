...
@OnlyIn(Dist.CLIENT)
public class PylonConsumeParticle extends TextureSheetParticle {
   ...
   public PylonConsumeParticle(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ) {
      super(world, x, y, z);
      this.xd = motionX;
      this.yd = motionY;
      this.zd = motionZ;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         ...
         PylonConsumeParticle scavengerAltarConsumeParticle = new PylonConsumeParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
