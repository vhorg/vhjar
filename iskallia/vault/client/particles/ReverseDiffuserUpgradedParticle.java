...
@OnlyIn(Dist.CLIENT)
public class ReverseDiffuserUpgradedParticle extends TextureSheetParticle {
   ...
   ReverseDiffuserUpgradedParticle(
   ...
   public void tick() {
      ...
      if (this.age++ >= this.lifetime) {
         ...
         float f = 1.0F - (float)this.age / this.lifetime;
         ...
         this.y = this.yStart - 0.05F + f1 * 0.1F;
         this.z = this.zStart + this.zd * f;
         double x1 = this.x - this.xStart;
         double z1 = this.z - this.zStart;
         double x2 = x1 * Math.cos(Math.toRadians((this.lifetime - this.age) * this.dir * 2))
            - z1 * Math.sin(Math.toRadians((this.lifetime - this.age) * this.dir * 2));
         double z2 = x1 * Math.sin(Math.toRadians((this.lifetime - this.age) * this.dir * 2))
            + z1 * Math.cos(Math.toRadians((this.lifetime - this.age) * this.dir * 2));
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         ReverseDiffuserUpgradedParticle diffuserParticle = new ReverseDiffuserUpgradedParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, this.sprite);
