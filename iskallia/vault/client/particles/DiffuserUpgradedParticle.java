...
@OnlyIn(Dist.CLIENT)
public class DiffuserUpgradedParticle extends TextureSheetParticle {
   ...
   public void tick() {
      ...
      if (this.age++ >= this.lifetime) {
         ...
         this.y = this.yStart - 0.1 + Math.abs(1.0F - f1) * 0.2F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         DiffuserUpgradedParticle diffuserParticle = new DiffuserUpgradedParticle(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed, this.sprite);
