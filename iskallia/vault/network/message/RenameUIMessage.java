      ...
      context.enqueueWork(() -> {
         ...
         switch (message.renameType) {
            case PLAYER_STATUE:
               ...
               TileEntity tex = sender.func_130014_f_().func_175625_s(statuePos);
               if (tex instanceof LootStatueTileEntity) {
                  LootStatueTileEntity statue = (LootStatueTileEntity)tex;
