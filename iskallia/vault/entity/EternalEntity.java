...
public class EternalEntity extends ZombieEntity {
   ...
   protected void func_175456_n() {
      super.func_175456_n();
      this.field_70715_bh.func_75776_a(2, new FollowEntityGoal(this, 1.0, 32.0F, 3.0F, false, () -> this.getOwner().right()));
   }
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_70729_aU) {
         if (this.field_70170_p.field_72995_K) {
            ...
            if (this.func_184102_h().func_71259_af() >= this.despawnTime) {
               this.func_174812_G();
            }
   ...
   private void updateAttackTarget() {
      ...
      this.field_70170_p.func_225316_b(LivingEntity.class, box, e -> {
         ...
         return o.right().isPresent() && o.right().get() == e ? false : !(e instanceof EternalEntity);
   ...
   public void func_213281_b(CompoundNBT compound) {
      ...
      compound.func_74772_a("DespawnTime", this.despawnTime);
      if (this.owner != null) {
   ...
   public void func_70037_a(CompoundNBT compound) {
      ...
      this.bossInfo.func_186739_a(this.func_145748_c_());
      this.despawnTime = compound.func_74763_f("DespawnTime");
