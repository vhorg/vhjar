...
public class ThrowAttack implements IMeleeAttack {
   ...
   private final ArtifactBossEntity artifactBossEntity;
   private final double damageMultiplier;
   private boolean hasThrown = false;
   private int throwCooldown = 0;
   private final Set<UUID> playersThrown = new HashSet<>();

   public ThrowAttack(ArtifactBossEntity artifactBossEntity, double damageMultiplier) {
   ...
   public Optional<ArtifactBossEntity.AttackMove> getAttackMove() {
      return Optional.of(ArtifactBossEntity.AttackMove.SUMMON);
   }
}
