...
public interface IMeleeAttack {
   ...
   default boolean isWithinAttackableSlice(ArtifactBossEntity boss, LivingEntity target, float closenessRatioRequired, float angleOffset) {
      if (target == null) {
         return false;
      } else {
   ...
   default void knockbackTarget(ArtifactBossEntity boss, LivingEntity target, double horizontalKnockbackMultiplier, double verticalKnockbackMultiplier) {
