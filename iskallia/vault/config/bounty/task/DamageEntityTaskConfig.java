...
public class DamageEntityTaskConfig extends TaskConfig<TaskEntry<ResourceLocation>, DamageProperties> {
   ...
   protected TaskEntry<ResourceLocation> generateConfigEntry() {
      return new TaskEntry<>(
            new GenericEntry<>(ForgeRegistries.ENTITIES.getKey(EntityType.SKELETON), new RangeEntry(100, 500))
               .floorToNearestTen()
         ...
         .addEntry(
            new GenericEntry<>(ForgeRegistries.ENTITIES.getKey(EntityType.ZOMBIE), new RangeEntry(100, 500))
               .floorToNearestTen()
               .setValidDimensions(Set.of(VaultMod.id("vault")))
               .vaultOnly(),
            3
         ...
         .addEntry(
            new GenericEntry<>(ForgeRegistries.ENTITIES.getKey(EntityType.CREEPER), new RangeEntry(100, 500))
               .floorToNearestTen()
