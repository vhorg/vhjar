...
public class SetsConfig extends Config {
   ...
   protected void reset() {
      this.DRAGON = SetGroup.of("Dragon", 1, i -> new PlayerSet(VaultGear.Set.DRAGON));
      ...
      this.DRYAD = SetGroup.of(
         "Dryad", 1, i -> new EffectSet(VaultGear.Set.DRYAD, Effects.field_76428_l, 2, EffectTalent.Type.ICON_ONLY, EffectTalent.Operator.ADD)
      );
      ...
      this.NINJA = SetGroup.of("Ninja", 1, i -> new NinjaSet(0.2F));
