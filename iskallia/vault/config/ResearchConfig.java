...
public class ResearchConfig extends Config {
   ...
   public Research getByName(String name) {
      for (Research research : this.getAll()) {
   ...
   protected void reset() {
      ...
      this.MOD_RESEARCHES
         .add(new ModResearch("Organisation", 3, "trashcans", "dankstorage", "pickletweaks").withRestrictions(false, false, false, false, true));
      ...
      this.MOD_RESEARCHES
         .add(new ModResearch("Storage Master", 2, "storage_overhaul", "storagedrawers", "modularrouters").withRestrictions(false, false, false, false, true));
      ...
      this.MOD_RESEARCHES
         .add(
            new ModResearch("Decorator Pro", 2, "mcwbridges", "mcwdoors", "mcwroofs", "mcwwindows", "enviromats", "blockcarpentry", "platforms")
      ...
      this.MOD_RESEARCHES
         .add(new ModResearch("Super Engineer", 3, "movingelevators", "immersiveengineering").withRestrictions(false, false, false, false, true));
