...
import iskallia.vault.core.event.common.PlayerCraftEvent;
import iskallia.vault.core.event.common.PlayerEquipmentSwapEvent;
...
public class CommonEvents {
   ...
   public static final EntityHurtEvent ENTITY_HURT = register(new EntityHurtEvent());
   ...
   public static final EntityLeaveEvent ENTITY_LEAVE = register(new EntityLeaveEvent());
   ...
   public static final PlayerActionEvent PLAYER_ACTION = register(new PlayerActionEvent());
   public static final PlayerCraftEvent PLAYER_CRAFT = register(new PlayerCraftEvent());
   ...
   public static final PlayerEquipmentSwapEvent PLAYER_EQUIPMENT_SWAP = register(new PlayerEquipmentSwapEvent());
   public static final ScavengerAltarConsumeEvent SCAVENGER_ALTAR_CONSUME = register(new ScavengerAltarConsumeEvent());
   public static final ItemScavengeTaskEvent ITEM_SCAVENGE_TASK = register(new ItemScavengeTaskEvent());
