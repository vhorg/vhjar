...
public class ModifierContext extends DataObject<ModifierContext> {
   ...
   public static final FieldKey<ResourceLocation> GROUP = FieldKey.of("group", ResourceLocation.class)
      .with(Version.v1_17, Adapters.IDENTIFIER, DISK.all())
      .register(FIELDS);
   ...
   public Optional<ResourceLocation> getGroup() {
      return this.getOptional(GROUP);
   }
   ...
   public ModifierContext copy() {
      return new ModifierContext()
         ...
         .setIf(GROUP, this.get(GROUP), v -> this.has(GROUP));
   }
}
