...
public class PylonExtension extends ClockModifier {
   ...
   public static final FieldKey<UUID> PLAYER = FieldKey.of("player", UUID.class).with(Version.v1_6, Adapters.UUID, DISK.all()).register(FIELDS);
   public static final FieldKey<Integer> INCREMENT = FieldKey.of("increment", Integer.class)
      .with(Version.v1_6, Adapters.INT_SEGMENTED_7, DISK.all())
      .register(FIELDS);
