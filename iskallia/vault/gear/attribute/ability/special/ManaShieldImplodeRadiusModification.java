...
public class ManaShieldImplodeRadiusModification extends FloatValueAbilityModification<FloatValueConfig> {
   public static final ResourceLocation ID = VaultMod.id("mana_shield_implode_increased_range");

   public ManaShieldImplodeRadiusModification() {
      super(ID);
   }
   ...
   public MutableComponent getDisplay(FloatValueConfig config, Style style, VaultGearModifier.AffixType type) {
      ...
      return valueDisplay == null
         ...
         : new TextComponent("")
            ...
            .append(" increased ")
            .append(new TextComponent("Mana Shield: Implode").withStyle(getAbilityStyle()))
            .append(" radius");
   }
   ...
   public void serializeTextElements(JsonArray out, FloatValueConfig config, VaultGearModifier.AffixType type) {
      ...
      if (valueDisplay != null) {
         ...
         out.add(" increased Mana Shield: Implode radius");
      }
   }
}
