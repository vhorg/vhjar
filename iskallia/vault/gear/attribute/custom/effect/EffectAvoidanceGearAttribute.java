...
public class EffectAvoidanceGearAttribute implements IEffectAvoidanceChanceAttribute {
   ...
   private static class Generator extends ConfigurableAttributeGenerator<EffectAvoidanceGearAttribute, EffectAvoidanceGearAttribute.Config> {
      ...
      public Optional<Float> getRollPercentage(EffectAvoidanceGearAttribute value, List<EffectAvoidanceGearAttribute.Config> configurations) {
         return MiscUtils.getFloatValueRange(
            value.getChance(), this.getMinimumValue(configurations), this.getMaximumValue(configurations), EffectAvoidanceGearAttribute::getChance
         );
      }
   }
      ...
      public MutableComponent getDisplay(VaultGearAttributeInstance<EffectAvoidanceGearAttribute> instance, VaultGearModifier.AffixType type) {
         ...
         return valueDisplay == null
            ...
            : new TextComponent(type.getAffixPrefix(effectAvoidance.getChance() >= 0.0F))
               ...
               .append(" ")
               .append(
                  new TranslatableComponent("the_vault.gear_attribute.effect_avoidance.avoidance", new Object[]{effectAvoidance.getEffect().getDisplayName()})
               )
