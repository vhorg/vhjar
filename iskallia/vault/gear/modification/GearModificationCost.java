...
public record GearModificationCost(int costPlating, int costBronze) {
   ...
   public static GearModificationCost getCost(VaultGearRarity gearRarity, String rollType, int gearLevel, int gearPotential, GearModification modification) {
      ...
      if (cfg == null) {
         ...
         float maxPotential = ModConfigs.VAULT_GEAR_CRAFTING_CONFIG.getMaxCraftingPotential(gearRarity, rollType) * (1.0F + incPotential);
