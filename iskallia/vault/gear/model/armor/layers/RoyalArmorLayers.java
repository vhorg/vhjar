      ...
      public static LayerDefinition createBodyLayer() {
         ...
         PartDefinition head = partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
               ...
               .texOffs(40, 50)
               .addBox(-3.0F, -8.0F, -5.0F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(28, 52)
               .addBox(-2.0F, -9.0F, -5.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(28, 50)
               .addBox(-2.0F, -9.0F, 4.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(0, 17)
               .addBox(-1.0F, -10.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(0, 6)
               .addBox(-1.0F, -10.0F, 4.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(36, 0)
               .addBox(-3.0F, -8.0F, 4.0F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(32, 50)
               .addBox(-5.0F, -8.0F, -3.0F, 1.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
               .texOffs(28, 0)
               .addBox(4.0F, -8.0F, -3.0F, 1.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
               .texOffs(28, 3)
               .addBox(-4.0F, -8.0F, -4.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(28, 0)
               .addBox(-4.0F, -8.0F, 3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(24, 20)
               .addBox(3.0F, -8.0F, 3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(24, 17)
               .addBox(3.0F, -8.0F, -4.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(60, 32)
               .addBox(-5.0F, -9.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
               .texOffs(0, 3)
               .addBox(-5.0F, -10.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
               .texOffs(38, 4)
               .addBox(4.0F, -9.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
               .texOffs(0, 0)
               .addBox(4.0F, -10.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
               .texOffs(27, 45)
               .addBox(-2.2F, -7.5F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(27, 41)
               .addBox(-2.2F, -7.5F, 4.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(24, 44)
               .addBox(1.2F, -7.5F, -5.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(24, 40)
               .addBox(1.2F, -7.5F, 4.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(4, 22)
               .addBox(-0.4F, -8.5F, -5.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(0, 19)
               .addBox(-0.4F, -8.5F, 4.15F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(0, 22)
               .addBox(4.4F, -8.5F, -0.55F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(44, 5)
               .addBox(4.4F, -7.5F, -2.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(44, 3)
               .addBox(4.4F, -7.5F, 1.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(27, 43)
               .addBox(-5.2F, -7.5F, 1.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(24, 42)
               .addBox(-5.2F, -7.5F, -2.35F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(4, 19)
               .addBox(-5.3F, -8.5F, -0.55F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 0.0F, 0.0F)
         );
         PartDefinition body = partdefinition.addOrReplaceChild(
            "body",
