...
public class KnightArmorLayers extends ArmorLayers {
   @OnlyIn(Dist.CLIENT)
   @Override
   public Supplier<LayerDefinition> getGeometrySupplier(EquipmentSlot equipmentSlot) {
      return equipmentSlot == EquipmentSlot.LEGS ? KnightArmorLayers.LeggingsLayer::createBodyLayer : KnightArmorLayers.MainLayer::createBodyLayer;
   }

   @OnlyIn(Dist.CLIENT)
   @Override
   public ArmorLayers.VaultArmorLayerSupplier<? extends ArmorLayers.BaseLayer> getLayerSupplier(EquipmentSlot equipmentSlot) {
      return equipmentSlot == EquipmentSlot.LEGS ? KnightArmorLayers.LeggingsLayer::new : KnightArmorLayers.MainLayer::new;
   }
   ...
   public static class MainLayer extends ArmorLayers.MainLayer {
      ...
      public static LayerDefinition createBodyLayer() {
         ...
         PartDefinition cube_r4 = body.addOrReplaceChild(
            "cube_r4",
            CubeListBuilder.create().texOffs(18, 0).addBox(-8.0F, -1.1F, -3.0F, 8.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.0F, 13.0F, 0.0F, 0.0F, 0.0F, -1.2217F)
         );
         PartDefinition cube_r5 = body.addOrReplaceChild(
            "cube_r5",
            CubeListBuilder.create().texOffs(32, 44).addBox(-4.0F, 1.0F, -6.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
         ...
         PartDefinition cube_r6 = right_arm.addOrReplaceChild(
            ...
            CubeListBuilder.create()
               .texOffs(29, 9)
               .addBox(-2.0F, -4.5F, -3.5F, 2.0F, 7.0F, 7.0F, new CubeDeformation(0.0F))
               .texOffs(29, 9)
               .addBox(-4.0F, -6.5F, -3.5F, 2.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-4.0F, 4.5F, 0.0F, 0.0F, 0.0F, 0.4363F)
         );
         ...
         PartDefinition cube_r7 = left_arm.addOrReplaceChild(
            ...
            CubeListBuilder.create()
               .texOffs(29, 9)
               .addBox(0.0F, -4.5F, -3.5F, 2.0F, 7.0F, 7.0F, new CubeDeformation(0.0F))
               .texOffs(29, 9)
               .addBox(2.0F, -6.5F, -3.5F, 2.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(4.0F, 4.5F, 0.0F, 0.0F, 0.0F, -0.4363F)
         );
         PartDefinition right_leg = partdefinition.addOrReplaceChild(
            "right_leg",
