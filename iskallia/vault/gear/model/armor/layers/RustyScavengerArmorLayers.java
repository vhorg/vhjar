...
public class RustyScavengerArmorLayers extends ArmorLayers {
   @OnlyIn(Dist.CLIENT)
   @Override
   public Supplier<LayerDefinition> getGeometrySupplier(EquipmentSlot equipmentSlot) {
      return equipmentSlot == EquipmentSlot.LEGS
         ? RustyScavengerArmorLayers.LeggingsLayer::createBodyLayer
         : RustyScavengerArmorLayers.MainLayer::createBodyLayer;
   }

   @OnlyIn(Dist.CLIENT)
   @Override
   public ArmorLayers.VaultArmorLayerSupplier<? extends ArmorLayers.BaseLayer> getLayerSupplier(EquipmentSlot equipmentSlot) {
      return equipmentSlot == EquipmentSlot.LEGS ? RustyScavengerArmorLayers.LeggingsLayer::new : RustyScavengerArmorLayers.MainLayer::new;
   }
   ...
   public static class MainLayer extends ArmorLayers.MainLayer {
      ...
      public static LayerDefinition createBodyLayer() {
         ...
         PartDefinition cube_r1 = head.addOrReplaceChild(
            "cube_r1",
            CubeListBuilder.create().texOffs(4, 4).addBox(-0.5F, -12.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, 0.0F)
         );
         PartDefinition cube_r2 = head.addOrReplaceChild(
            "cube_r2",
            CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -14.0F, -3.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
         ...
         PartDefinition right_arm = partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
               ...
               .texOffs(4, 4)
               .addBox(-3.5F, -7.0F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(4, 4)
               .addBox(-3.5F, -7.0F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(20, 25)
               .addBox(-7.5F, -2.0F, -2.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(20, 25)
               .addBox(-7.5F, -2.0F, 1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
               .texOffs(32, 0)
