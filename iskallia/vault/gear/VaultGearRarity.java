...
public enum VaultGearRarity {
   SCRAPPY(ChatFormatting.GRAY, 2, 2, 1, 1, 0, 1, 1, 1),
   COMMON(ChatFormatting.AQUA, 3, 3, 2, 2, 1, 2, 2, 2),
   RARE(ChatFormatting.YELLOW, 4, 4, 3, 3, 2, 3, 3, 3),
   EPIC(ChatFormatting.LIGHT_PURPLE, 5, 5, 4, 4, 3, 4, 4, 4),
   OMEGA(ChatFormatting.GREEN, 6, 6, 5, 5, 4, 5, 5, 5),
   UNIQUE(TextColor.fromRgb(-1213660), 0, 0, 0, 0, 0, 0, 0, 0);
