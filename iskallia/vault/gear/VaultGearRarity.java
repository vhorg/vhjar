...
public enum VaultGearRarity {
   SCRAPPY(ChatFormatting.GRAY, 2, 2, 0, 1),
   COMMON(ChatFormatting.AQUA, 3, 3, 1, 2),
   RARE(ChatFormatting.YELLOW, 4, 4, 2, 3),
   EPIC(ChatFormatting.LIGHT_PURPLE, 5, 5, 3, 4),
   OMEGA(ChatFormatting.GREEN, 6, 6, 4, 5),
