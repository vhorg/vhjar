...
public class RaidChallengeGenerator extends VaultGenerator {
   ...
   public boolean generate(ServerLevel world, VaultRaid vault, MutableBlockPos pos) {
      ...
      try {
         ...
         StructureStart start = ((RaidChallengeStructure.Feature)ModFeatures.RAID_CHALLENGE_FEATURE.value())
         ...
         world.getChunk(chunkPos.x, chunkPos.z, ChunkStatus.EMPTY, true)
            .setStartForFeature((ConfiguredStructureFeature)ModFeatures.RAID_CHALLENGE_FEATURE.value(), start);
