...
public class FinalBossGenerator extends VaultGenerator {
   ...
   public FinalBossGenerator(ResourceLocation id) {
      super(id);
      this.frameBlocks
   ...
   public FinalBossGenerator setDepth(int depth) {
      this.depth = depth;
      return this;
   }
   ...
   public boolean generate(ServerWorld world, VaultRaid vault, Mutable pos) {
      ...
      try {
         ...
         StructureStart<?> start = ModFeatures.FINAL_VAULT_BOSS_FEATURE
         ...
         world.func_217353_a(chunkPos.field_77276_a, chunkPos.field_77275_b, ChunkStatus.field_223226_a_, true)
            .func_230344_a_(ModStructures.FINAL_VAULT_BOSS, start);
