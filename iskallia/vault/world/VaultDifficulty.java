...
public enum VaultDifficulty {
   ...
   private final boolean championRange;
   ...
   private VaultDifficulty(
      ...
      this.championRange = championRange;
   ...
   public boolean shouldChampionRangeAttack() {
      return this.championRange;
   }
