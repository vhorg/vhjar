...
public class VaultTroveStructure extends StructureFeature<JigsawConfiguration> {
   public static final ResourceKey<StructureTemplatePool> POOL = ResourceKey.create(Registry.TEMPLATE_POOL_REGISTRY, VaultMod.id("trove/starts"));

   public VaultTroveStructure() {
   ...
   public VaultTroveStructure.Feature configured() {
      return new VaultTroveStructure.Feature(
   ...
   public static class Feature extends ConfiguredStructureFeature<JigsawConfiguration, VaultTroveStructure> implements IRegistryIdentifiable {
      private ResourceLocation id;

      public Feature(
         VaultTroveStructure structure,
      ...
      public StructureStart generate(
         ...
         JigsawConfiguration config = new JigsawConfiguration(
            registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).getHolderOrThrow(VaultTroveStructure.POOL), 1
         );
