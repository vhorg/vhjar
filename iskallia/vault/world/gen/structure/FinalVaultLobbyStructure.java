...
public class FinalVaultLobbyStructure extends StructureFeature<JigsawConfiguration> {
   public static final ResourceKey<StructureTemplatePool> POOL = ResourceKey.create(Registry.TEMPLATE_POOL_REGISTRY, VaultMod.id("final_vault/starts"));

   public FinalVaultLobbyStructure() {
   ...
   public FinalVaultLobbyStructure.Feature configured() {
      return new FinalVaultLobbyStructure.Feature(
   ...
   public static class Feature extends ConfiguredStructureFeature<JigsawConfiguration, FinalVaultLobbyStructure> implements IRegistryIdentifiable {
      private ResourceLocation id;

      public Feature(
         FinalVaultLobbyStructure structure,
      ...
      public StructureStart generate(
         ...
         JigsawConfiguration config = new JigsawConfiguration(
            registry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).getHolderOrThrow(FinalVaultLobbyStructure.POOL), 1
         );
