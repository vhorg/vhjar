...
public class FinalVaultBossFeature extends StructureFeature<FinalVaultBossStructure.Config, Structure<FinalVaultBossStructure.Config>> {
   public FinalVaultBossFeature(Structure<FinalVaultBossStructure.Config> p_i231937_1_, FinalVaultBossStructure.Config p_i231937_2_) {
   ...
   public StructureStart<?> generate(
      ...
      FinalVaultBossStructure.Start start = (FinalVaultBossStructure.Start)this.field_236268_b_
         .func_214557_a()
         .create(
