...
import iskallia.vault.config.HeraldConfig;
...
import iskallia.vault.config.OfferingBossConfig;
...
import iskallia.vault.config.achievement.AchievementConfig;
...
public class ModConfigs {
   ...
   public static HeraldConfig HERALD;
   public static VaultBossConfig VAULT_BOSS;
   ...
   public static BingoConfig BINGO;
   public static AntiquesConfig ANTIQUES;
   public static CardModifiersConfig CARD_MODIFIERS;
   public static CardScalersConfig CARD_SCALERS;
   public static CardConditionsConfig CARD_CONDITIONS;
   public static CardTasksConfig CARD_TASKS;
   ...
   public static void register() {
      ...
      HERALD = new HeraldConfig().readConfig();
      VAULT_BOSS = new VaultBossConfig().readConfig();
      ...
      ACHIEVEMENT = new AchievementConfig().readConfig();
      ANTIQUES = new AntiquesConfig().readConfig();
      CARD_MODIFIERS = new CardModifiersConfig().readConfig();
      CARD_SCALERS = new CardScalersConfig().readConfig();
      CARD_CONDITIONS = new CardConditionsConfig().readConfig();
      CARD_TASKS = new CardTasksConfig().readConfig();
