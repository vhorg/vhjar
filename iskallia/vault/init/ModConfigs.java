...
public class ModConfigs {
   ...
   public static GearRecipesConfig GEAR_RECIPES_CONFIG;
   public static JewelRecipesConfig JEWEL_RECIPES_CONFIG;
   public static TrinketRecipesConfig TRINKET_RECIPES_CONFIG;
   public static ToolRecipesConfig TOOL_RECIPES_CONFIG;
   ...
   public static void register() {
      ...
      GEAR_RECIPES_CONFIG = new GearRecipesConfig().readConfig();
      JEWEL_RECIPES_CONFIG = new JewelRecipesConfig().readConfig();
      TRINKET_RECIPES_CONFIG = new TrinketRecipesConfig().readConfig();
      TOOL_RECIPES_CONFIG = new ToolRecipesConfig().readConfig();
