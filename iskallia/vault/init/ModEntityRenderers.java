...
import iskallia.vault.block.render.BloodOrbRenderer;
...
import iskallia.vault.entity.renderer.BoogiemanBossRenderer;
import iskallia.vault.entity.renderer.BoogiemanRenderer;
import iskallia.vault.entity.renderer.BossProtectionCatalystRenderer;
...
import iskallia.vault.entity.renderer.GolemHandProjectileRenderer;
...
import iskallia.vault.entity.renderer.SwampZombieRenderer;
import iskallia.vault.entity.renderer.TeamTaskScoreboardRenderer;
...
import iskallia.vault.entity.renderer.VaultWraithRenderer;
import iskallia.vault.entity.renderer.WinterWolfRenderer;
import iskallia.vault.entity.renderer.bloodhorde.Tier1BloodHordeRenderer;
import iskallia.vault.entity.renderer.bloodhorde.Tier2BloodHordeRenderer;
import iskallia.vault.entity.renderer.bloodhorde.Tier3BloodHordeRenderer;
import iskallia.vault.entity.renderer.bloodhorde.Tier4BloodHordeRenderer;
import iskallia.vault.entity.renderer.bloodhorde.Tier5BloodHordeRenderer;
import iskallia.vault.entity.renderer.bloodmoon.BloodSilverfishRenderer;
import iskallia.vault.entity.renderer.bloodmoon.BloodSlimeRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier0BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier1BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier2BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier3BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier4BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.bloodmoon.Tier5BloodSkeletonRenderer;
import iskallia.vault.entity.renderer.cave.CaveSkeletonRenderer;
...
import iskallia.vault.entity.renderer.elite.EndervexRenderer;
import iskallia.vault.entity.renderer.elite.RaisedZombieChickenRenderer;
import iskallia.vault.entity.renderer.elite.RaisedZombieRenderer;
import iskallia.vault.entity.renderer.elite.ScarabRenderer;
...
import iskallia.vault.entity.renderer.guardian.BasicGuardianRenderer;
import iskallia.vault.entity.renderer.guardian.ButcherGuardianRenderer;
import iskallia.vault.entity.renderer.guardian.CrystalGuardianRenderer;
import iskallia.vault.entity.renderer.guardian.PirateGuardianRenderer;
...
import iskallia.vault.entity.renderer.mushroom.LevishroomRenderer;
...
import iskallia.vault.entity.renderer.overgrown_woodman.Tier0OvergrownWoodmanRenderer;
import iskallia.vault.entity.renderer.overgrown_woodman.Tier1OvergrownWoodmanRenderer;
import iskallia.vault.entity.renderer.overgrown_woodman.Tier2OvergrownWoodmanRenderer;
...
import iskallia.vault.entity.renderer.plastic.PlasticSkeletonRenderer;
import iskallia.vault.entity.renderer.plastic.PlasticSkeletonTier4Renderer;
import iskallia.vault.entity.renderer.plastic.PlasticSlimeRenderer;
import iskallia.vault.entity.renderer.plastic.PlasticZombieRenderer;
...
import iskallia.vault.entity.renderer.tank.BloodTankRenderer;
import iskallia.vault.entity.renderer.tank.OvergrownTankRenderer;
...
public class ModEntityRenderers {
   public static void register(FMLClientSetupEvent event) {
      ...
      EntityRenderers.register(ModEntities.SWAMP_ZOMBIE, SwampZombieRenderer::new);
      ...
      EntityRenderers.register(ModEntities.NAGA, NagaRenderer::new);
      ...
      EntityRenderers.register(ModEntities.SCARAB, ScarabRenderer::new);
      EntityRenderers.register(ModEntities.ENDERVEX, EndervexRenderer::new);
      EntityRenderers.register(ModEntities.RAISED_ZOMBIE, RaisedZombieRenderer::new);
      EntityRenderers.register(ModEntities.RAISED_ZOMBIE_CHICKEN, RaisedZombieChickenRenderer::new);
      EntityRenderers.register(ModEntities.BASIC_BRUISER_GUARDIAN, BasicGuardianRenderer::new);
      EntityRenderers.register(ModEntities.BASIC_ARBALIST_GUARDIAN, BasicGuardianRenderer::new);
      EntityRenderers.register(ModEntities.PIRATE_BRUISER_GUARDIAN, PirateGuardianRenderer.Bruiser::new);
      EntityRenderers.register(ModEntities.PIRATE_ARBALIST_GUARDIAN, PirateGuardianRenderer.Arbalist::new);
      EntityRenderers.register(ModEntities.CRYSTAL_BRUISER_GUARDIAN, CrystalGuardianRenderer::new);
      EntityRenderers.register(ModEntities.CRYSTAL_ARBALIST_GUARDIAN, CrystalGuardianRenderer::new);
      EntityRenderers.register(ModEntities.BUTCHER_BRUISER_GUARDIAN, ButcherGuardianRenderer.Bruiser::new);
      EntityRenderers.register(ModEntities.BUTCHER_ARBALIST_GUARDIAN, ButcherGuardianRenderer.Arbalist::new);
      ...
      EntityRenderers.register(ModEntities.T0_OVERGROWN_WOODMAN, Tier0OvergrownWoodmanRenderer::new);
      EntityRenderers.register(ModEntities.T1_OVERGROWN_WOODMAN, Tier1OvergrownWoodmanRenderer::new);
      EntityRenderers.register(ModEntities.T2_OVERGROWN_WOODMAN, Tier2OvergrownWoodmanRenderer::new);
      ...
      EntityRenderers.register(ModEntities.LEVISHROOM, LevishroomRenderer::new);
      ...
      EntityRenderers.register(ModEntities.T1_BLOOD_HORDE, Tier1BloodHordeRenderer::new);
      EntityRenderers.register(ModEntities.T2_BLOOD_HORDE, Tier2BloodHordeRenderer::new);
      EntityRenderers.register(ModEntities.T3_BLOOD_HORDE, Tier3BloodHordeRenderer::new);
      EntityRenderers.register(ModEntities.T4_BLOOD_HORDE, Tier4BloodHordeRenderer::new);
      EntityRenderers.register(ModEntities.T5_BLOOD_HORDE, Tier5BloodHordeRenderer::new);
      EntityRenderers.register(ModEntities.T0_BLOOD_SKELETON, Tier0BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T1_BLOOD_SKELETON, Tier1BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T2_BLOOD_SKELETON, Tier2BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T3_BLOOD_SKELETON, Tier3BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T4_BLOOD_SKELETON, Tier4BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T5_BLOOD_SKELETON, Tier5BloodSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.BLOOD_SILVERFISH, BloodSilverfishRenderer::new);
      EntityRenderers.register(ModEntities.BLOOD_SLIME, BloodSlimeRenderer::new);
      ...
      EntityRenderers.register(ModEntities.BLOOD_TANK, BloodTankRenderer::new);
      EntityRenderers.register(ModEntities.OVERGROWN_TANK, OvergrownTankRenderer::new);
      ...
      EntityRenderers.register(ModEntities.T1_PLASTIC_ZOMBIE, PlasticZombieRenderer::new);
      EntityRenderers.register(ModEntities.T2_PLASTIC_ZOMBIE, PlasticZombieRenderer::new);
      EntityRenderers.register(ModEntities.T3_PLASTIC_ZOMBIE, PlasticZombieRenderer::new);
      EntityRenderers.register(ModEntities.T4_PLASTIC_ZOMBIE, PlasticZombieRenderer::new);
      EntityRenderers.register(ModEntities.T1_PLASTIC_SKELETON, PlasticSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T2_PLASTIC_SKELETON, PlasticSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T3_PLASTIC_SKELETON, PlasticSkeletonRenderer::new);
      EntityRenderers.register(ModEntities.T4_PLASTIC_SKELETON, PlasticSkeletonTier4Renderer::new);
      EntityRenderers.register(ModEntities.T1_PLASTIC_SLIME, PlasticSlimeRenderer::new);
      EntityRenderers.register(ModEntities.T2_PLASTIC_SLIME, PlasticSlimeRenderer::new);
      EntityRenderers.register(ModEntities.T3_PLASTIC_SLIME, PlasticSlimeRenderer::new);
      EntityRenderers.register(ModEntities.T4_PLASTIC_SLIME, PlasticSlimeRenderer::new);
      EntityRenderers.register(ModEntities.T0_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T0_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.T1_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T1_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.T2_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T2_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.T3_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T3_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.T4_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T4_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.T5_CAVE_SKELETON, context -> new CaveSkeletonRenderer(context, ModModelLayers.T5_CAVE_SKELETON));
      EntityRenderers.register(ModEntities.VAULT_WRAITH_YELLOW, context -> new VaultWraithRenderer(context, ModModelLayers.VAULT_WRAITH_YELLOW));
      EntityRenderers.register(ModEntities.VAULT_WRAITH_WHITE, context -> new VaultWraithRenderer(context, ModModelLayers.VAULT_WRAITH_WHITE));
      ...
      EntityRenderers.register(ModEntities.ARTIFACT_BOSS, ArtifactBossRenderer::new);
      EntityRenderers.register(ModEntities.MAGIC_PROJECTILE, MagicProjectileRenderer::new);
      EntityRenderers.register(ModEntities.CONJURATION_MAGIC_PROJECTILE, MagicProjectileRenderer::new);
      EntityRenderers.register(ModEntities.BOSS_PROTECTION_CATALYST, BossProtectionCatalystRenderer::new);
      EntityRenderers.register(ModEntities.CATALYST_INHIBITOR, ThrownItemRenderer::new);
      EntityRenderers.register(ModEntities.THROWN_COBWEB, ThrownItemRenderer::new);
      ...
      EntityRenderers.register(ModEntities.GOLEM_HAND_PROJECTILE, GolemHandProjectileRenderer::new);
      EntityRenderers.register(ModEntities.BOOGIEMAN_BOSS, BoogiemanBossRenderer::new);
      EntityRenderers.register(ModEntities.BLACK_WIDOW_BOSS, BlackWidowBossRenderer::new);
      EntityRenderers.register(ModEntities.TEAM_TASK_SCOREBOARD, TeamTaskScoreboardRenderer::new);
   }
}
