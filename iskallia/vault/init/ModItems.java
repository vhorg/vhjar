...
import iskallia.vault.item.VialOfSandItem;
import iskallia.vault.item.gear.EtchingItem;
import iskallia.vault.item.gear.VaultArmorItem;
import iskallia.vault.item.gear.VaultAxeItem;
import iskallia.vault.item.gear.VaultDaggerItem;
...
public class ModItems {
   ...
   public static BasicItem KEY_PIECE = new BasicItem(Vault.id("key_piece"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem KEY_MOULD = new BasicItem(Vault.id("key_mould"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem BLANK_KEY = new BasicItem(Vault.id("blank_key"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem NETHERITE_CLUSTER = new BasicItem(Vault.id("cluster_netherite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem ALEXANDRITE_CLUSTER = new BasicItem(
      Vault.id("cluster_alexandrite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64)
   );
   public static BasicItem BENITOITE_CLUSTER = new BasicItem(Vault.id("cluster_benitoite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem LARIMAR_CLUSTER = new BasicItem(Vault.id("cluster_larimar"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem BLACK_OPAL_CLUSTER = new BasicItem(Vault.id("cluster_black_opal"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem PAINITE_CLUSTER = new BasicItem(Vault.id("cluster_painite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem ISKALLIUM_CLUSTER = new BasicItem(Vault.id("cluster_iskallium"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem RENIUM_CLUSTER = new BasicItem(Vault.id("cluster_renium"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem GORGINITE_CLUSTER = new BasicItem(Vault.id("cluster_gorginite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem SPARKLETINE_CLUSTER = new BasicItem(
      Vault.id("cluster_sparkletine"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64)
   );
   public static BasicItem WUTODIE_CLUSTER = new BasicItem(Vault.id("cluster_wutodie"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   ...
   public static VaultXPFoodItem OOZING_PIZZA = new VaultXPFoodItem(
      Vault.id("oozing_pizza"), () -> 0.0F, () -> 0.0F, new Properties().func_200916_a(VAULT_MOD_GROUP)
   );
   ...
   public static VialOfSandItem VIAL_OF_SAND = new VialOfSandItem(Vault.id("vial_of_sand"), new Properties().func_200916_a(VAULT_MOD_GROUP));
   public static BasicItem VAULT_SCRAP = new BasicItem(Vault.id("vault_scrap"), new Properties().func_200916_a(VAULT_MOD_GROUP));
   ...
   public static LootableItem MYSTERY_BOX = new LootableItem(
      Vault.id("mystery_box"), new Properties().func_200916_a(VAULT_MOD_GROUP), () -> ModConfigs.MYSTERY_BOX.POOL.getRandom(new Random()).toStack()
   );
   public static BasicItem ACCELERATION_CHIP = new BasicItem(Vault.id("acceleration_chip"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static LootableItem PANDORAS_BOX = new LootableItem(
      Vault.id("pandoras_box"), new Properties().func_200916_a(VAULT_MOD_GROUP), () -> ModConfigs.PANDORAS_BOX.POOL.getRandom(new Random()).toStack()
   );
   public static BasicItem NETHERITE_CHUNK = new BasicItem(Vault.id("chunk_netherite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem ALEXANDRITE_CHUNK = new BasicItem(Vault.id("chunk_alexandrite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem BENITOITE_CHUNK = new BasicItem(Vault.id("chunk_benitoite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem LARIMAR_CHUNK = new BasicItem(Vault.id("chunk_larimar"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem BLACK_OPAL_CHUNK = new BasicItem(Vault.id("chunk_black_opal"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem PAINITE_CHUNK = new BasicItem(Vault.id("chunk_painite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem ISKALLIUM_CHUNK = new BasicItem(Vault.id("chunk_iskallium"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem RENIUM_CHUNK = new BasicItem(Vault.id("chunk_renium"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem GORGINITE_CHUNK = new BasicItem(Vault.id("chunk_gorginite"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem SPARKLETINE_CHUNK = new BasicItem(Vault.id("chunk_sparkletine"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem WUTODIE_CHUNK = new BasicItem(Vault.id("chunk_wutodie"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem OMEGA_POG = new BasicItem(Vault.id("omega_pog"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem ETERNAL_SOUL = new BasicItem(Vault.id("eternal_soul"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem SPARK = new BasicItem(Vault.id("spark"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem VOID_CORE = new BasicItem(Vault.id("void_core"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem STAR_SHARD = new BasicItem(Vault.id("star_shard"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem STAR_CORE = new BasicItem(Vault.id("star_core"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   public static BasicItem STAR_ESSENCE = new BasicItem(Vault.id("star_essence"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64));
   ...
   public static VaultDaggerItem DAGGER = new VaultDaggerItem(Vault.id("dagger"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(1));
   ...
   public static BasicItem INFUSED_ETERNAL_SOUL = new BasicItem(
      Vault.id("infused_eternal_soul"), new Properties().func_200916_a(VAULT_MOD_GROUP).func_200917_a(64)
   );
