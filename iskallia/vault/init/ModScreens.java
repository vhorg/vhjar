...
import iskallia.vault.client.gui.screen.ModifierDiscoveryScreenFixed;
...
import iskallia.vault.client.gui.screen.VaultKeyringScreen;
...
import iskallia.vault.client.gui.screen.block.JevelCraftingTableScreen;
...
public class ModScreens {
   public static void register() {
      ...
      MenuScreens.register(ModContainers.VAULT_KEYRING_CONTAINER, VaultKeyringScreen::new);
      ...
      MenuScreens.register(ModContainers.JEWEL_CRAFTING_TABLE_CONTAINER, JevelCraftingTableScreen::new);
      ...
      MenuScreens.register(ModContainers.MODIFIER_ARCHIVE_CONTAINER, ModifierDiscoveryScreenFixed.create());
      MenuScreens.register(ModContainers.MODIFIER_SCROLL_CONTAINER, ModifierDiscoveryScreenFixed.create());
